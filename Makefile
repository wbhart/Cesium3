...
OBJS=backend.o inference.o environment.o types.o symbol.o input.o ast.o exception.o parser.o
HEADERS=ast.h exception.h input.h symbol.h types.h environment.h inference.h backend.h
