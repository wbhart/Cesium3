...
{ 
  ...
  morekeywords={int8,int16,int32,int64,int},
  morekeywords={uint8,uint16,uint32,uint64},
  morekeywords={uint,char,string,double,float},
  morekeywords={i,u,i8,i16,i32,i64,u8,u16,u32,u64},
  sensitive=true,
  morestring=[b]",
  morestring=[b]',
}
...
simple and flexible syntax. C is fiddly and low level, but very fast. 
...
certain keywords. However, in general, statements end with an end-of-line.
