...
\subsection{The ``type'' declaration}
...
default constructor for the type of the same name. This is a function which takes a set of values
as parameters and returns a value of the newly defined type with those values in the respective
fields of the type.
