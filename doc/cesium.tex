...
with tuple assignment. For example:

\begin{lstlisting}
(i, j, k) = (0, 1, "string")
\end{lstlisting}

defines variables \code{i}, \code{j} and \code{k} (if they don't already exist), and assigns the
values \code{0}, \code{1} and \code{"string"}, respectively, to them.
