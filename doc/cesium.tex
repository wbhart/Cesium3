...
with tuple assignment. For example, the following code defines variables \code{i}, \code{j} and 
\code{k} (if they don't already exist), and assigns the values \code{0}, \code{1} and 
